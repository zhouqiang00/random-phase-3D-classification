...
public:
    ...
    void iterate();
	// Modified by ZhouQ
	//replace all other references with phase-randomized first reference
	void randomize_phase_otherrefs();
	//Broadcast phase-randomized references
	void get_phase_randomized_refs();
