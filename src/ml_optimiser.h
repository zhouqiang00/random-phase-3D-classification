...
public:
	...
	// Modified by ZhouQ
	// Random phase other refs than first one
	bool do_random_phase_otherrefs;
	// Lower limit of resolution of random phase
	DOUBLE random_phase_res;
	// Upper limit of resolution of random phase
	DOUBLE random_phase_res_upper;
